...
Extracted **26,808 line features** intersecting the broad EXP-001 envelope (138.5E–154.2E, 39.8S–25.0S). The envelope is an extraction convenience, not a VECA preferred corridor.

## Network-length QA

Summing the source `length_km` attribute gives **26,099.4 km of source line-segments** across all statuses/types, of which approximately **17,729.2 km** are labelled Operational or Fully capable of operation.

By feature subtype the source contains approximately **24,755.7 km Railway**, **773.1 km Rail Siding** and **570.7 km Tramline** within the extraction envelope (all operational statuses combined).

`length_km` was missing/unparseable on 0 of 26,808 features.
